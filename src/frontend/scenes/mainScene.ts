...
export default class MainScene extends Phaser.Scene {
  ...
  create() {
    //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    this.add.text(500,300,"KRESS anywhere to JUMP", {fontSize:"75px"}).setOrigin(.5,.5)
    ...
    this.matter.world.setBounds(0,0,1024,750, 50,true, true, true, true)
      ...
      this.socket = io()
      this.socket.on("first ZDRAVO", (data: UserData, opponentData: UserData[])=>{
  ...
  updateState(){
    ...
    return ()=>{
      ...
      this.playersConnectedText.setText("KLIJENTI KONEKTOVANI: "+(this.opponents.length+1).toString())
