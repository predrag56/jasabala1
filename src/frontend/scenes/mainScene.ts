...
export default class MainScene extends Phaser.Scene {
  ...
  create() {
    //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    this.add.text(500,300,"KRESS bilo-gdje to JUMP", {fontSize:"75px"}).setOrigin(.5,.5)
  ...
  updateState(){
    ...
    return ()=>{
      ...
      this.playersConnectedText.setText("SPOJENI KLIJENTI: "+(this.opponents.length+1).toString())
